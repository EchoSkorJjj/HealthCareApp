            ...
            <Offcanvas show={show} onHide={handleClose} responsive="lg">
                ...
                <div className='sidebar-content'>
                    <Nav.Link href="/homepage" className='sidebar-item'>
                        <FontAwesomeIcon icon={faHome} className="fa-1x pe-2" /><span className='sidebar-text'>Home Page</span>
                    </Nav.Link>
                </div>
                <div className='sidebar-content'>
                    <Nav.Link href="/dashboard" className='sidebar-item'>
                        <FontAwesomeIcon icon={faTableColumns} className="fa-1x pe-2" /><span className='sidebar-text'>Dashboard</span>
                    </Nav.Link>
                </div>
                <div className='sidebar-content'>
                    <Nav.Link href="/nutrition" className='sidebar-item'>
                        <FontAwesomeIcon icon={faSearchengin} className="fa-1x pe-2" /><span className='sidebar-text'>Nutrition Analyzer</span>
                    </Nav.Link>
                </div>
                <div className='sidebar-content'>
                    <Nav.Link href="/recipe" className='sidebar-item'>
                        <FontAwesomeIcon icon={faMagnifyingGlass} className="fa-1x pe-2" /><span className='sidebar-text'>Search Recipe</span>
                    </Nav.Link>
                </div>
                <div className='sidebar-content'>
                    <Nav.Link href="/services" className='sidebar-item'>
                        <FontAwesomeIcon icon={faWrench} className="fa-1x pe-2" /><span className='sidebar-text'>Services</span>
                    </Nav.Link>
                </div>
                <div className='sidebar-content'>
                    <Nav.Link href="/contact" className='sidebar-item'>
                        <FontAwesomeIcon icon={faEnvelope} className="fa-1x pe-2" /><span className='sidebar-text'>Contact</span>
                    </Nav.Link>
                </div>
                <div className='sidebar-content'>
                    <Nav.Link href="/profile" className='sidebar-item'>
                        <FontAwesomeIcon icon={faUser} className="fa-1x pe-2"/><span className='sidebar-text'>Profile</span>
                    </Nav.Link>
                </div>
                <div className='sidebar-content'>
                    <Nav.Link href="/settings" className='sidebar-item'>
                        <FontAwesomeIcon icon={faGear} className="fa-1x pe-2"/><span className='sidebar-text'>Settings</span>
                    </Nav.Link>
                </div>
                <div className='sidebar-content'>
                    <button onClick={() => setShowLogoutModal(true)} className='logout-button bg-transparent'>
                        <FontAwesomeIcon icon={faRightFromBracket} className="fa-1x pe-2"/><span className='sidebar-text'>Log Out</span>
                    </button>
