        ...
        try {
            ...
            if (response.ok) {
              ...
              try {
                ...
                window.alert(`Settings Update Failed: ${errorMessage}`);
              } catch (error) {
            ...
            <div className="container py-5">
                <div className="row">
                    ...
                    <div className='col-lg-9'>
                        <div className="card">
                            <div className="card-header setting-header">
                            ...
                            <div className="card-body">
                                <form className="row mb-3 gy-3" onSubmit={handleSubmit}>
                                    ...
                                    <div className="col-12">
                                        <button className="btn btn-primary float-start" type="submit">Submit form</button>
                                    </div>
                                </form>
                            </div>
                        </div>
