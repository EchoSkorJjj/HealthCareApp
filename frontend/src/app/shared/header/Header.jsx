...
export default function Header({onToggle, handleLogout}) {
    ...
    return (
        <Navbar id="header-navbar" key='lg' expand='lg' className="row bg-body-tertiary" >
            ...
            <Navbar.Toggle aria-controls={`offcanvasNavbar-expand-lg`} onClick={handleShow} className="border-0">
                <FontAwesomeIcon icon={faEllipsis} className="me-2 fa-solid fa-2x"/>
            </Navbar.Toggle>
                <Navbar.Offcanvas
